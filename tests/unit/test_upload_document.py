...
from app.application.dtos.document_dtos import DocumentUploadDTO, DocumentUploadResponseDTO
...
class TestUploadDocument:
    ...
    @pytest.mark.asyncio
    async def test_upload_document_success(self, use_case, mock_file_storage_service, mock_document_repository):
    ...
    @pytest.mark.asyncio
    async def test_upload_document_with_optional_metadata(self, use_case, mock_document_repository):
