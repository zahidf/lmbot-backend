...
class TestDocumentUploadAPI:
    ...
    def test_upload_document_docx_success(self, auth_headers):
        ...
        files = {
            "file": ("guide.docx", io.BytesIO(file_content), "application/vnd.openxmlformats-officedocument.wordprocessingml.document")
        }
        data = {
    ...
    def test_upload_document_with_optional_metadata(self, auth_headers):
        ...
        file_content = b"PDF content"
        files = {
            "file": ("manual.pdf", io.BytesIO(file_content), "application/pdf")
        }
        data = {
