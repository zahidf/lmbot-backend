...
if __name__ == "__main__":
    ...
    image_parser = LLMImageBlobParser(model=ChatOpenAI(model="gpt-4.1-mini", max_tokens=1024))
    loader = PyMuPDF4LLMLoader(file_path, mode="single", pages_delimiter="----END OF PAGE----", extract_images=True, images_parser=image_parser, table_strategy="lines")
    docs = loader.load()
